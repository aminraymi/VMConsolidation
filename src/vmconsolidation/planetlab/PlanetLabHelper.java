package vmconsolidation.planetlab;
...
import vmconsolidation.helper.Constants;
			...
			try {
				cloudlet = new Cloudlet(
						...
						new UtilizationModelPlanetLabInMemory(
								...
								Constants.SCHEDULING_INTERVAL), new UtilizationModelStochastic(), new UtilizationModelStochastic());
			} catch (Exception e) {
				e.printStackTrace();
				System.exit(0);
			}
