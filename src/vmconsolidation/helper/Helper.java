...
import vmconsolidation.MyCloudletSchedulerDynamicWorkload;
import vmconsolidation.PlacementUtils;
import vmconsolidation.PowerDatacenter;
import vmconsolidation.PowerDatacenterBroker;
import vmconsolidation.PowerHost;
import vmconsolidation.PowerHostUtilizationHistory;
import vmconsolidation.PowerVm;
...
public class Helper {
	...
	public static List<Vm> createVmList(int brokerId, int vmsNumber) {
		...
		for (int i = 0; i < vmsNumber; i++) {
			...
			vms.add(new PowerVm(
					...
					1,
					"Xen",
					new MyCloudletSchedulerDynamicWorkload(Constants.VM_MIPS[vmType], Constants.VM_PES[vmType]),
	...
	public static void printResults(
		...
		List<Host> hosts = datacenter.getHostList();
                ...
                PlacementUtils.createSimulationResults(hosts);
