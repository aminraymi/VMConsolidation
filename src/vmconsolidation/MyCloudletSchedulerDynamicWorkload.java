 ...
 * @author Amin
 */
public class MyCloudletSchedulerDynamicWorkload extends MyCloudletSchedulerTimeShared {
     ...
     */
    public MyCloudletSchedulerDynamicWorkload(double mips, int numberOfPes) {
        super();
        setMips(mips);
